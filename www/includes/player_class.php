...
class player extends app_obj
{
    ...
    public function set_hashpass($hashpass)
    {
        $this -> _hashpass = (string) $hashpass;
    }
    ...
    public function set_activcode($activcode)
    {
        $this -> _activcode = (int) $activcode;
    }
    public function set_paidto($paidto)
    {
        $this -> _paidto = (int) $paidto;
    }
    ...
    public function get_var_names()
    {
        ...
        foreach ($var_and_default_value as $name => $value) {
            $var_names[] = substr($name, 1);
        }
        return $var_names;
    }
